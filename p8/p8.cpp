...
//*************				Práctica 08  Grupo_02 Ejercicio de Clase						******//
//*************		Visual Studio 2017 ------- Dado									******//
//************************************************************//
//************************************************************//
#include "texture.h"
...
void prisma (GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
	...
	GLfloat vertice [8][3] = {
		...
		glBegin(GL_POLYGON);	//Front
			...
			glTexCoord2f(0.50f, 0.33f); glVertex3fv(vertice[4]);
			glTexCoord2f(0.50f, 0.66f); glVertex3fv(vertice[7]);
